...
📖 **Full Documentation:** See [`DOCKER-QUICKREF.md`](DOCKER-QUICKREF.md) or [`docker/DOCKER.md`](docker/DOCKER.md)

**Development:**

```bash
# Edit code, then sync to container
cd docker
./sync-code.sh                    # Sync all files
...
```bash
cd docker
./build-prod.sh v1.0.0           # Build from git
./check-version.sh prod          # Verify version
```
...
-   Password: adminasy to use, open source, Learning Management System\*\*
